...
const teamMembers = [
  {
    name: "Haris Kamal",
    role: "CEO & Co-Founder",
    bio: "Fleet operations and logistics technology. Former VP at FleetPro.",
    avatar: "HK",
    color: "#1E6FFF",
  },
  {
    name: "Wahad Ahmad",
    role: "CTO & Co-Founder",
    bio: "Software engineer with a passion for scalable IoT systems and data platforms.",
    avatar: "WA",
    color: "#7C3AED",
  },
  {
    ...
    bio: "Product leader with deep expertise in building enterprise SaaS solutions for mobility.",
    avatar: "SR",
    color: "#059669",
  },
];
        ...
        <div className="container">
          <div className="about-hero-content">
            ...
            <h1 className="section-title">
              We believe every fleet
              <br />
              <span>deserves to run perfectly</span>
            </h1>
            <p className="section-subtitle">
              Founded in 2026 by a team of fleet operators and engineers who
              were tired of outdated, overpriced telematics systems — DriveVital
              was built to be different. We combine cutting-edge technology with
              genuine industry expertise to deliver a platform that actually
              moves the needle.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="story-layout">
            <div className="story-text">
              ...
              <p>
                Our founders Haris Kamal, Wahad Ahmad and Salman Rasool met
                while working at a regional logistics company where they managed
                a fleet of 80 delivery vehicles. Despite spending thousands on
                legacy telematics software, they were drowning in disconnected
                dashboards, late alerts, and data that told them what happened —
                not what to do about it.
              </p>
              <p>
                They left to build the platform they always wished existed. One
                that's intelligent, actionable, and actually helps fleet
                managers make better decisions in real time.
              </p>
              <p>
                Today, DriveVital serves over 2,000 businesses across Pakistan —
                from single-van startups to 1,000-vehicle enterprise fleets.
              </p>
            </div>
        ...
        <div className="container">
          <div className="section-header center">
            ...
            <p className="section-subtitle section-subtitle-center">
              A diverse team of engineers, operators, and customer advocates
              united by a mission to make fleet management effortless.
            </p>
          </div>
